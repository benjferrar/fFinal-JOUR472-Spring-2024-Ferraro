...
md_gov_county <- md_gov_county |> mutate(moore_pct = moore/(cox + moore + lashar + wallace + harding)*100)
...
**Task** Click the "Customize tooltips" button so it expands down. Change {{ fips_code }} to {{ county }} and {{ pctmoore }} to {{ FORMAT(pctmoore, "0.0%")}} **Answer** Describe the changes from the previous map
