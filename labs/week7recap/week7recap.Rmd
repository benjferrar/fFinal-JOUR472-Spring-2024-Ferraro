...
**A1:** There is an http link in the read_csv(), meaning there is a website available for use.
...
**A2:** 10365 records. It tracks all the earthquakes from Feb. 23 to now. We can gather all sorts of data from longitudes and latitudes to MagTypes.
...
**A4: There are 4 earthquakes with a magnitude larger than 6.**
...
**A5: There are 3 earthquakes that have a magnitude higher than 6 and a depth smaller than 20.**
...
earthquakes |>
  group_by(type) |>
  summarize(count_tremors =n()) |>
  arrange(desc(count_tremors))
```

**A8: Earthquakes and quarry blast**
...
**A9: The average depth of a quarry blast is -1.0602353, ice quake is 0, explosion is 0.2741379, other event 6.3, and earthquake is 21.6701636. Earthquakes have by far the highest average depth compared to other tremor types.**
