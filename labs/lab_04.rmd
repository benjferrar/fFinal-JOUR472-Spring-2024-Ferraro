...
**Some of the candidates seem to be running for the House, councilmember positions, and county executives, seeming to want to be elected or re-elected.**
...
**Q4.** The media expense data you cleaned also has a standardized purpose column. Write code to generate a list of the committees with the total amount of spending on online advertising. How does this list compare to the one from Q1 about top Facebook spenders? Of the top 5 committees who spent the most on Facebook ads from Q1, are there any that appear to have spent *all* of their online advertising I

**I got the same answer as question 1, it seems maybe I group by something else other than committee_name?**
...
**The best story idea I have is is there correlations between candidates who run for office vs the amount they spend on Facebook ads.**
