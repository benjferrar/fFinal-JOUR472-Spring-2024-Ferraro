...
opd_releases <- opd_results |> html_elements('a.wixui-rich-text_text') |> html_text() |> as_tibble()
...
results <- "https://www.cardin.senate.gov/?post_type=press-releases"|> read_html()
