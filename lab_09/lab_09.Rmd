...
md_gov_county_joined <- md_gov_county |> inner_join(md_gov_county_18, by=c('geoid','county'))

md_gov_county_joined <- md_gov_county_joined |> mutate(pct_cox= cox/(cox+ moore + lashar + wallace + harding + sefcik + write_ins.x),
