...
# Look, I know you're to R and maybe this library function doesn't make sense to you right now, but trust me and run it and we'll talk about it later.
library(tidyverse)
```
...
**Answer 60712 observations and 8 variables**
...
**Answer Breaking down the terms and classes offered in each term**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer The data is sorted by most classes offered per term**
